En gros il y a plusieurs niveaux d'autorité : admin (moi), organisateurs (vous), chefs (les chefs des sections animatrices), animateurs (les pios, scouts etc) et enfin les participants.
